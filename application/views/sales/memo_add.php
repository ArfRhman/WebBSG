                            ...
                            <form class="form-horizontal" enctype="multipart/form-data" action="<?php echo site_url('sales/memo/save');?>" method="post">
                                <fieldset>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3">
                                            <input id="name" name="memo_subject" placeholder="Subject" class="form-control" type="text"></div>                                                                                      
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-3">
                                                    <input id="email" name="memo_addressed" placeholder="Addressed To" class="form-control" type="text"></div>                                                                                      
                                                </div>
                                                <div class="form-group">
