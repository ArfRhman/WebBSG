										...
										<fieldset>
											...
											<div class="form-group">
												...
												<div class="col-md-3">
													...
													<input id="no" name="no" placeholder="No" class="form-control" type="text"></div>
											...
											<div class="form-group">
												...
												<div class="col-md-3">
													...
													<input id="pureq_date" name="pureq_date" placeholder="Pureq Date" class="form-control" type="text"></div>
											...
											<div class="form-group">
												...
												<div class="col-md-3">
													...
													<input id="gr_date" name="gr_date" placeholder="GR Date" class="form-control" type="text"></div>
											...
											<div class="form-group">
												...
												<div class="col-md-3">
													...
													<input id="packing_date" name="packing_date" placeholder="Packing List Date" class="form-control" type="text"></div>
											...
											<div class="form-group">
												...
												<div class="col-md-3">
													...
													<input id="lc_date" name="lc_date" placeholder="LC Date" class="form-control" type="text"></div>
