                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-3">
                      ...
                      <input type="text" class="form-control" placeholder="Expediture Name" name="name" list="divisionList" value="<?php echo $so->row()->name; ?>">
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-3">
                          <input value="<?php echo $so->row()->debit_note_amount;?>" id="email" name="debit_note" placeholder="Debit Note Amount" class="form-control" type="text">
                          </div> 
                        </div>
                        <div class="form-group">
