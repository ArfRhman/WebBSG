                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-3">
                                                            <input id="email" name="til" placeholder="dd MM YYYY" class="form-control datepicker" type="text"></div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-3">
                                                                <div class="input-group">
                                                                    ...
                                                                    <input aria-describedby="basic-addon1" id="idr" name="usd" placeholder="00.000" class="form-control" type="text">
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-3">
                                                                <div class="input-group">
                                                                    <span class="input-group-addon" id="basic-addon1">IDR</span>
                                                                    <input aria-describedby="basic-addon1" name="sgd" placeholder="00.000" class="form-control" type="text">
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-3">
                                                                <div class="input-group">
                                                                    <span class="input-group-addon" id="basic-addon1">IDR</span>
                                                                    <input aria-describedby="basic-addon1" name="eur" placeholder="00.000" class="form-control" type="text">
                                                                </div>
                                                            </div>
