       ...
       $.ajax({
        ...
        success: function(daddta){
         ...
         for (var i = 0; i<aa.length; i++) {
               ...
               startEditForm(bsda,id);

           }
       });
   }
   function startEditForm(bsda,id){
    var bsd = '<select class="org-input form-control"><option value="">-- Pilih Personnel --</option> '+ bsda + '</select>';
        // var bsd2 = '<input class="org-input form-control" type="text" value="'+nodes[id].data.name+'"/>';
