                                ...
                                <form class="form-horizontal" enctype="multipart/form-data" action="<?php echo site_url('sales/budget/save');?>" method="post">
                                    <fieldset>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-3">
                                                <input id="email" name="budget_cd" placeholder="Budget Code" class="form-control" type="text"></div>																						<label class="col-md-2 control-label" for="email">Main Budget</label>
                                            <div class="col-md-3">
                                                <input id="email" name="main_budget" placeholder="Main Budget" class="form-control" type="text"></div>      
                                        </div>
										<div class="form-group">
                                           <label class="col-md-2 control-label" for="email">Sub Budget Level 1</label>
                                            <div class="col-md-3">
                                                <input id="email" name="sub_budget_lv1" placeholder="Sub Budget Level 1" class="form-control" type="text"></div>            																				<label class="col-md-2 control-label" for="email">Sub Budget Level 2</label>
                                            <div class="col-md-3">
                                                <input id="email" name="sub_budget_lv2" placeholder="Sub Budget Level 2" class="form-control" type="text"></div>
                                        </div>
										<div class="form-group">
                                           <label class="col-md-2 control-label" for="email">Periode</label>
                                            <div class="col-md-3">
                                                <input id="email" name="periode" placeholder="Periode" class="form-control" type="text"></div>                                                                                         <div class="form-group">
