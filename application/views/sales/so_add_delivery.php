                                ...
                                <form class="form-horizontal" enctype="multipart/form-data" action="<?php echo site_url('sales/so/save_delivery/'.$this->uri->segment(4));?>" method="post">
                                    <fieldset>
										...
										<div class="form-group">
                                            ...
                                            <div class="col-md-3">
                                                <input id="email" name="delivery" placeholder="Delivery Date" class="form-control datepicker" type="text"></div>																						<label class="col-md-2 control-label" for="email">Delivery By</label>                                            <div class="col-md-3">                                                <input id="email" name="delivery_by" placeholder="Delivery By" class="form-control" type="text"></div>
                                        </div>
										<div class="form-group">
										...
										<div class="form-group">
                                            ...
                                            <div class="col-md-3">
                                                <input id="email" name="awb_no" placeholder="awb/receipt no" class="form-control" type="text"></div>																						<label class="col-md-2 control-label" for="email">Depart Date</label>                                            <div class="col-md-3">                                                <input id="email" name="depart" placeholder="Depart Date" class="form-control" type="text"></div>
                                        </div>
										<div class="form-group">
                                            <label class="col-md-2 control-label" for="email">Received Date</label>
                                            <div class="col-md-3">
                                                <input id="email" name="received" placeholder="Received Date" class="form-control" type="text"></div>																						<label class="col-md-2 control-label" for="email">Received By</label>                                            <div class="col-md-3">                                                <input id="email" name="received_by" placeholder="Received By" class="form-control" type="text"></div>
                                        </div>
										<div class="form-group">
