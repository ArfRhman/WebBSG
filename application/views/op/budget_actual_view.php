                               ...
                               <tbody>
                                ...
                                <tr>
                                    ...
                                    foreach ($bln2 as $bl) {
                                       ...
                                       $sql41 = $this->db->query("SELECT amount AS amb FROM tbl_op_budget WHERE budget_code = '".$d31->id."' AND SUBSTR(periode,1,3) = '".$bl."' AND SUBSTR(periode,5,4) = '".$thn."'")->row();
                                        $sql51 = $this->db->query("SELECT amount AS amr FROM tbl_op_realisasi WHERE budget_code = '".$d31->id."' AND SUBSTR(date,1,3) = '".$bl."' AND SUBSTR(date,5,4) = '".$thn."'")->row();
                                   ...
                                   <tr>
                                    ...
                                    <?php
                                    foreach ($bln2 as $bl) {
                                     $sql4 = $this->db->query("SELECT amount AS amb FROM tbl_op_budget WHERE SUBSTR(periode,1,3) = '".$bl."' AND SUBSTR(periode,5,4) = '".$thn."' AND budget_code='".$d3->id."'")->row();
                                     $sql5 = $this->db->query("SELECT amount AS amr FROM tbl_op_realisasi WHERE SUBSTR(date,1,3) = '".$bl."' AND SUBSTR(date,5,4) = '".$thn."' AND budget_code='".$d3->id."'")->row();
                                     ?>
