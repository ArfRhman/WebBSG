  ...
  <section class="content">
    <div class="row">
      <div class="col-lg-12">
        ...
        {
          ?>							<a href="<?php echo site_url('op/price/table_add')?>" class="btn btn-success">Add New Data</a>
          <?php
        }
        ?>
                ...
                <td>
                  <div class='btn-group'>
                    ...
                    <ul class='dropdown-menu pull-right' role='menu'>
                      <li><a href='<?php echo site_url('op/price/table_edit')?>' >Edit</a></li>
                      <li><a href='<?php echo site_url('op/price/delete')?>' class="delete">Delete</a></li>
                    </ul>
                  </div>
                </td>
              </tr>
