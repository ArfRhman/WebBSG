                                ...
                                <form class="form-horizontal" enctype="multipart/form-data" action="<?php echo site_url('op/hs/save');?>" method="post">
                                    <fieldset>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-3">
                                                <input id="created" name="hs_code" placeholder="HS Code" class="form-control" type="text"></div>
                                             <label class="col-md-2 control-label" for="created">% HS Code</label>
                                              <div class="col-md-3">
                                               <div class="input-group">
                                                <input aria-describedby="basic-addon1" id="presented" name="hs_percent_code" placeholder="% HS Code" class="form-control" type="text">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-3">
                                               <input id="presented" name="hs_items" placeholder="Items" class="form-control" type="text"></div>
                                            <label class="col-md-2 control-label" for="price">Description Eng.</label>

                                            <div class="col-md-3">
                                                <input id="price" name="hs_desc_eng" placeholder="Description Eng." class="form-control" type="text">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-3">
                                                <input id="shared" name="hs_desc_ind" placeholder="Description Ind." class="form-control" type="text"></div>
                                            <label class="col-md-2 control-label" for="delivery">Tarif Preference</label>

                                            <div class="col-md-3">
                                                <input id="delivery" name="hs_trf_pref" placeholder="Tarif Preference" class="form-control" type="text">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-3">
                                                <input id="effective" name="hs_lartas" placeholder="Lartas" class="form-control" type="text"></div>
                                         ...
                                         <div class="form-group">
                                            ...
                                            <div class="col-md-3">
                                                <input id="effective" name="hs_other"  class="form-control" placeholder="Other Information" >
                                        </div>
                                      </div>
                                        <div class="form-group">
