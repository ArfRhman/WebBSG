...

					{
						...
						<div class="panel panel-primary" id="hidepanel1">
							...
							<div class="panel-body">
								...
								<form class="form-horizontal" enctype="multipart/form-data" action="<?php echo site_url('op/outgoing/update');?>" method="post">
									<input type="hidden" name="no" value="<?=$out->no?>">
									<fieldset>
										...
										<div class="form-group">
											...
											<div class="col-md-3">
												...
												<input id="name" value="<?=$out->ol_date?>" name="outgoing_date" placeholder="Outgoing Letter Date" class="form-control datepicker" type="text">
											</div>
											...
											<div class="col-md-3">												
												<select name="outgoing_addressed_to" class="form-control">
													...
													{
														?>
														<option value="<?php echo $s->id; ?>" <?=$out->addressed_to==$s->id ? 'selected' : '' ?>><?php echo $s->name ?></option>
														<?php
													}
													?>
												</select> 
										...
										<div class="form-group">
											...
											<div class="col-md-3">
												...
												<input id="email" value="<?=$out->subject?>" name="outgoing_subject" placeholder="Subject" class="form-control" type="text"></div>
												...
												<div class="col-md-3">
													...
													<select name="outgoing_signer_by" class="form-control">
														...
														{
															?>
															<option value="<?php echo $c->id; ?>" <?=$out->signer_by==$c->id ? 'selected' : ''?>><?php echo $c->name; ?></option>	
															<?php
														}
														?>
													</select>
											...
											<div class="form-group">
												...
												<div class="col-md-3">
													...
													<input id="email" value="<?=$out->description?>" name="desc" placeholder="Description" class="form-control" type="text">
												</div>
												...
												<div class="col-md-3">
													...
													<input id="email" value="<?=$out->archive_code?>" name="outgoing_archive_code" placeholder="Archive Code" class="form-control" type="text">
												</div>
