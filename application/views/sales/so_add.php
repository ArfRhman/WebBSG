                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                      ...
                                      <div class="form-group">
                                        ...
                                        <div class="col-md-3">
                                        <input type="text" class="form-control" placeholder="Division" name="division" list="divisionList">
                                          <datalist id="divisionList">
                                                 <option value="WLN">
                                                  ...
                                                  </div>																						<label class="col-md-2 control-label" for="email">Operator</label>                                            <div class="col-md-3">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-3">
                                                        <input id="email" name="other_status" placeholder="Order Status" class="form-control" type="text"></div>																						<label class="col-md-2 control-label" for="email">Softcopy</label>                                            <div class="col-md-3">                                                <input name="softcopy" type="file"></div>
                                                    </div>
                                                    <div class="form-group">
