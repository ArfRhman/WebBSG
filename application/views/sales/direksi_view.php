      ...
      <section class="content">
        <div class="row">
            <div class="col-lg-12">
              ...
              {
                  ?>
                  <a href="<?php echo site_url('sales/direksi/add')?>" class="btn btn-success">Add New Data</a>
                  <?php
              }
              ?>
                          ...
                          <td>
                           <div class='btn-group'>
                            ...
                            <ul class='dropdown-menu pull-right' role='menu'>
                                <li><a href='<?php echo site_url('sales/direksi/edit/'.$c->no)?>' >Edit</a></li>
                                <li><a href='<?php echo site_url('sales/direksi/delete/'.$c->no)?>' class="delete">Delete</a></li>
                            </ul>
                        </div>
                    </td>
                </tr>
