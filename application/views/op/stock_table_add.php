        ...
        <div class="row">
            ...
            <div class="panel panel-primary" id="hidepanel1">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" enctype="multipart/form-data" action="<?php echo site_url('op/stock/table_save');?>" method="post">
                        <input type="hidden" name="st_no" value="<?=$this->uri->segment(4)?>">
