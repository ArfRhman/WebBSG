                        ...
                        <div class="col-md-3">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <input id="jml_approve" name="jml_approve" placeholder="Jumlah Diapprove" class="form-control" type="text" onkeypress='return event.charCode >= 48 && event.charCode <= 57' onkeyup="JumlahSelisih(this)"></div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-3">
                                                <input id="tglByr" name="tgl_byr_kasbon" placeholder="dd MMM YYYY" class="form-control datepicker" type="text">
                                            </div>
                                            <label class="col-md-2 control-label" for="date">Tanggal Warning</label>
                                            <div class="col-md-3">
                                                <input id="tglWrn" name="tgl_warning" placeholder="dd MMM YYYY" class="form-control datepicker" type="text" readonly></div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-2 control-label" for="no">Tanggal Overdue Realisasi</label>
                                                <div class="col-md-3">
                                                    <input id="tglOvr" name="tgl_over_realisasi" placeholder="dd MMM YYYY" class="form-control datepicker" type="text" readonly>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-3">
                                                        <input id="jml_net" name="jml_net_realisasi" placeholder="Jumlah Net Realisasi" class="form-control" type="text" onkeypress='return event.charCode >= 48 && event.charCode <= 57' onkeyup="JumlahSelisih(this)"></div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="col-md-2 control-label" for="no">Jumlah Selisih</label>
                                                        <div class="col-md-3">
                                                            <input id="jml_selisih" name="jml_selisih" placeholder="Jumlah Selisih" class="form-control" type="text" readonly>
                                                        </div>
