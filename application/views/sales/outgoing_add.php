...

					{
						...
						<div class="panel panel-primary" id="hidepanel1">
							...
							<div class="panel-body">
								...
								<form class="form-horizontal" enctype="multipart/form-data" action="<?php echo site_url('sales/outgoing/save');?>" method="post">
									...
									<fieldset>
										...
										<div class="form-group">
											...
											<div class="col-md-3">
												...
												<input id="name" name="outgoing_date" placeholder="Outgoing Letter Date" class="form-control datepicker" type="text">
											</div>
										...
										<div class="form-group">
											...
											<div class="form-group">
												...
												<div class="col-md-3">
													...
													<input id="email" name="desc" placeholder="Description" class="form-control" type="text">
												</div>
												...
												<div class="col-md-3">
													...
													<input id="email" name="outgoing_archive_code" placeholder="Archive Code" class="form-control" type="text">
												</div>
