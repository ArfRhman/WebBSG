                ...
                <table class="table table-striped table-responsive" id="table1">
                    <thead>
                        <tr>
                            ...
                            <th>Detail Case</th>
                            <th>Personnels Involved</th>
                            <th>Date of Solving</th>
                            <th>Solving</th>
                            <th>Final Action</th>
                            <th>Conclusion</th>
                            <th>Action</th>
                    ...
                    <tbody>
                     ...
                     <tr>
                        ...
                        <td><?php echo $c->date_of_case ?></td>
                        <td><?php echo $c->subject_of_case ?></td>
                        <td><?php echo $c->detail_case ?></td>
                        <td><?php echo $c->personels_involved ?></td>
                        <td><?php echo $c->date_of_solving ?></td>
                        <td><?php echo $c->solving ?></td>
                        <td><?php echo $c->final_action ?></td>
                        <td><?php echo $c->conclusion ?></td>
                        <td>
                            <div class='btn-group'>
                                <button type='button' class='btn btn-sm dropdown-toggle' data-toggle='dropdown'><i class='fa fa-cogs'></i></button>
                                <ul class='dropdown-menu pull-right' role='menu'>
                                <li><a href='<?php echo site_url('op/cases/edit/'.$c->no)?>'>Edit</a></li>
                                    <li><a href='<?php echo site_url('op/cases/delete/'.$c->no)?>' class="delete">Delete</a></li>
                                </ul>
                            </div>
                        </td>
                    </tr>
