                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="panel panel-primary" id="hidepanel1">
                            ...
                            <div class="panel-body">
                                <form class="form-horizontal" enctype="multipart/form-data" action="<?php echo site_url('sales/policies/save');?>" method="post">
                                    <fieldset>
                                        <div class="form-group">
                                            <label class="col-md-2 control-label" for="name">Rule/Policy No.</label>
                                            <div class="col-md-3">
                                                <input id="name" name="policies_no" placeholder="Rule/Policy No" class="form-control" type="text"></div>                                                                                      <label class="col-md-2 control-label" for="email">Rule/Policy Date</label>                                          <div class="col-md-3">                                                <input id="name" name="policies_date" placeholder="Rule/Policy Date" class="form-control datepicker" type="text"></div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-2 control-label" for="email">Rule/Policy Type</label>
                                            <div class="col-md-3">
                                                <input id="email" name="policies_type" placeholder="Rule/Policy Type" class="form-control" type="text"></div>                                                                                      <label class="col-md-2 control-label" for="email">Desciption</label>                                            <div class="col-md-3">                                                <input id="email" name="policies_desc" placeholder="Desciption" class="form-control" type="text"></div>
                                        </div>
                                        <div class="form-group">
