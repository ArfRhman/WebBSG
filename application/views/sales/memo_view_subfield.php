                            ...
                            <div class="portlet-body">
								<div class="table-responsive">
                                    <table class="table table-striped table-bordered table-hover">
                                        ...
                                        <tbody>
											<?php
											echo form_open('sales/memo/save_subfield/'.$this->uri->segment(4));
											?>
											<tr>
												<td>
                                    ...
                                    <table class="table table-striped table-bordered table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
												...
												<td>
													<a href="<?php echo site_url('sales/memo/delete_subfield/'.$c->id)?>" class="btn btn-danger">Delete</a>
													<a href="<?php echo site_url('sales/memo/edit_subfield/'.$c->id)?>" class="btn btn-info">Edit</a>
												</td>
                                            </tr>
											<?php
											}
