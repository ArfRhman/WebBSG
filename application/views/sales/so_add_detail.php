                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                 <select name="item" class="form-control" id="itemID">
                                  ...
                                  ?>
                              </select> </div>																						<label class="col-md-2 control-label" for="email">Item Name</label>											<div class="col-md-3">                                                <input id="itemName" name="item_name" placeholder="Item Name" class="form-control" type="text"></div>
                          </div>
                          <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-3">
                                                <input id="email" name="discount" placeholder="Discount" class="form-control" type="text"></div>																						<label class="col-md-2 control-label" for="email">Delivery Cost</label>                                            <div class="col-md-3">                                                <input id="email" name="delivery" placeholder="Delivery Cost" class="form-control" type="text"></div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-2 control-label" for="email">Nett Before Tax</label>
                                                <div class="col-md-3">
                                                    <input id="email" name="nett_tax" placeholder="Nett Before Tax" class="form-control" type="text"></div>																						<label class="col-md-2 control-label" for="email">Vat 10%</label>                                            <div class="col-md-3">                                                <input id="email" name="vat" placeholder="Vat 10%" class="form-control" type="text"></div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-md-2 control-label" for="email">Grand Total</label>
                                                    <div class="col-md-3">
                                                        <input id="email" name="grand_total" placeholder="Grand Total" class="form-control" type="text"></div>
                                                    </div>
                                                    <div class="form-group">
