                                ...
                                <form class="form-horizontal" enctype="multipart/form-data" action="<?php echo site_url('op/hs/save');?>" method="post">
                                    <fieldset>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input id="name" name="code" placeholder="HS Code" class="form-control" type="text"></div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" for="email">Description</label>
											<div class="col-md-9">
                                                <input id="name" name="description" placeholder="Description" class="form-control" type="text"></div>
                                        </div>
										<div class="form-group">
                                            <label class="col-md-3 control-label" for="email">Uraian</label>
                                            <div class="col-md-9">
                                                <input id="email" name="uraian" placeholder="Uraian" class="form-control" type="text"></div>
                                        </div>
										<div class="form-group">
                                            <label class="col-md-3 control-label" for="email">Import Duty</label>
                                            <div class="col-md-8">
                                                <input id="email" name="duty" placeholder="Import Duty" class="form-control" type="text"></div>
											<label class="col-md-1 control-label" for="email">%</label>
                                        </div>
										<div class="form-group">
                                            <label class="col-md-3 control-label" for="email">Lartas</label>
                                            <div class="col-md-9">
                                                <input id="email" name="lartas" placeholder="Lartas" class="form-control" type="text"></div>
                                        </div>
										<div class="form-group">
                                            <label class="col-md-3 control-label" for="email">Jenis Barang</label>
                                            <div class="col-md-9">
                                                <input id="email" name="jenis" placeholder="Jenis Barang" class="form-control" type="text"></div>
                                        </div>
										<div class="form-group">
