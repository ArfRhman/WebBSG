                                ...
                                <form class="form-horizontal" enctype="multipart/form-data" action="<?php echo site_url('sales/so/save_cost/'.$this->uri->segment(4));?>" method="post">
                                    <fieldset>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-3">
                                                <input id="name" name="sales_com" placeholder="%Salescom Proposed" class="form-control" type="text"></div>																						<label class="col-md-2 control-label" for="email">Salescom Proposed</label>											<div class="col-md-3">                                                <input id="name" name="sales" placeholder="Salescom Proposed" class="form-control" type="text"></div>
                                        </div>
										<div class="form-group">
                                            <label class="col-md-2 control-label" for="email">%Bank Interest</label>
                                            <div class="col-md-3">
                                                <input id="email" name="bank_interest" placeholder="%Bank Interest" class="form-control" type="text"></div>																						<label class="col-md-2 control-label" for="email">Bank Interest</label>                                            <div class="col-md-3">                                                <input id="email" name="bank" placeholder="Bank Interest" class="form-control" type="text"></div>
                                        </div>
										<div class="form-group">
										...
										<div class="form-group">
                                            ...
                                            <div class="col-md-3">
												...
												<div class="col-md-3">
												<input id="email" name="extcom" placeholder="%Extcom Proposed" class="form-control" type="text"></div>
										</div>
										<div class="form-group">
                                            <label class="col-md-2 control-label" for="email">Extcom Proposed</label>
                                            <div class="col-md-3">
                                                <input id="email" name="extcom_pro" placeholder="Extcom Proposed" class="form-control" type="text"></div>
												<label class="col-md-2 control-label" for="email">Income Tax</label>
												<div class="col-md-3">
												<input id="email" name="income" placeholder="Income Tax" class="form-control" type="text"></div>
										</div>
										<div class="form-group">
                                            <label class="col-md-2 control-label" for="email">Nett Extcom</label>
                                            <div class="col-md-3">
                                                <input id="email" name="nett" placeholder="Nett Extcom" class="form-control" type="text"></div>
