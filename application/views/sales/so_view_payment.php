      ...
      <section class="content">
        <div class="row">
            <div class="col-lg-12">
              ...
              {
                  ?>
                  <a href="<?php echo site_url('sales/so/add_payment/'.$this->uri->segment(4))?>" class="btn btn-success">Add New Data</a>
                  <?php
              }
              ?>
                    ...
                    <tbody>
                       ...
                       foreach($so->result() as $c)
                       {
                           ...
                           <tr>
                             <td>
                                <?php 
                                $sql = $this->mddata->getDataFromTblWhere('tbl_sale_so_invoicing', 'id', $c->reference)->row();
                                echo $sql->no; ?></td>
                                <td><?php echo $c->due_date; ?></td>
                                <td><?php echo $c->payment_date; ?></td>
                                <td><?php echo $c->through; ?></td>
                                <td><?php echo $c->amount; ?></td>
                                <td><?php echo $c->account; ?></td>
                                ...
                                <td>
                                    <div class='btn-group'>
                                       ...
                                       <ul class='dropdown-menu pull-right' role='menu'>															
                                         <li><a href='<?php echo site_url('sales/so/edit_payment/'.$c->id);?>' >Edit</a></li>
                                         <li><a href='<?php echo site_url('sales/so/delete_payment/'.$c->id);?>'>Delete</a></li>
                                     </ul>													
                                 </div>
                             </td>
                         </tr>
