                ...
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-primary" id="hidepanel1">
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" enctype="multipart/form-data" action="<?php echo site_url('sales/memo/update');?>" method="post">
                                <input type="hidden" name="no" value="<?=$memo->no?>">
                                <fieldset>
                                    <div class="form-group">
                                        <label class="col-md-2 control-label" for="name">Subject</label>
                                        <div class="col-md-3">
                                            <input id="name" value="<?=$memo->subject?>" name="memo_subject" placeholder="Subject" class="form-control" type="text"></div>                                                                                      
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-3">
                                                    <input id="email" value="<?=$memo->addressed_to?>" name="memo_addressed" placeholder="Addressed To" class="form-control" type="text"></div>                                                                                      
                                                </div>
                                                <div class="form-group">
