                          ...
                          <td>
                            <div class='btn-group'>
                              ...
                              <ul class='dropdown-menu pull-right' role='menu'>                             
                                <li><a href='<?php echo site_url('op/realisasi/edit/'.$c->no)?>' >Edit</a></li>
                                <li><a href='<?php echo site_url('op/realisasi/delete/'.$c->no);?>' class="delete" data-id = "<?php echo $c->no;?>">Delete</a></li>
                            </ul>                         
                        </div>
                    </td>
                </tr>
