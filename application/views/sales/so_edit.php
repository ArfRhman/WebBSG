                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3">
                                            <input id="email" name="customer_id" placeholder="Customer ID" value="<?php echo $so->row()->customer_id; ?>"  class="form-control" type="text"></div>																						<label class="col-md-2 control-label" for="email">Customer Name</label>                                            <div class="col-md-3">                                        <select name="customer_name" class="form-control">
                                            <?php
                                            $sql = $this->mddata->getAllDataTbl('tbl_dm_customer');
                                            foreach($sql->result() as $s)
                                            {
                                                if($s->id == $so->row()->customer_name){
                                                ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3">
                                            <input id="email" name="address" placeholder="address" value="<?php echo $so->row()->address; ?>"  class="form-control" type="text"></div>																						<label class="col-md-2 control-label" for="email">Phone</label>                                            <div class="col-md-3">                                                <input id="email" value="<?php echo $so->row()->phone; ?>"  name="phone" placeholder="Phone" class="form-control" type="text"></div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-2 control-label" for="email">Fax</label>
                                            <div class="col-md-3">
                                                <input id="email" name="fax" value="<?php echo $so->row()->fax; ?>"  placeholder="Fax" class="form-control" type="text"></div>																						<label class="col-md-2 control-label" for="email">Account Manager</label>                                            <div class="col-md-3">                                               <select name="am" class="form-control">
                                            <?php
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-3">
                                                    <input id="email" name="division" placeholder="Division" value="<?php echo $so->row()->division; ?>"  class="form-control" type="text"></div>																						<label class="col-md-2 control-label" for="email">Operator</label>                                            <div class="col-md-3">                                                <select name="operator" class="form-control">
                                            <?php
