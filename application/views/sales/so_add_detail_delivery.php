        ...
        <div class="panel panel-primary" id="hidepanel1">
            <div class="panel-heading">
                <h3 class="panel-title">
                    ...
                    Add Detail Delivery Sales Order
                </h3>
            ...
            <div class="panel-body">
                <form class="form-horizontal" enctype="multipart/form-data" action="<?php echo site_url('sales/so/save_detail_delivery/'.$this->uri->segment(4));?>" method="post">
                    <fieldset>
