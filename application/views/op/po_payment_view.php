  ...
  <section class="content">
    <div class="row">
      <div class="col-lg-12">
        ...
        {
          ?>							<a href="<?php echo site_url('op/po/payment_add')?>" class="btn btn-success">Add New Data</a>
          <?php
        }
        ?>
            ...
            <tbody>
             ...
             foreach($in->result() as $c)
             {
               ...
               <tr>
                 ...
                 <td><?=$c->payment_proof?></td>

                 <td>                                                                                                       
                  <div class='btn-group'>
                    <button type='button' class='btn btn-sm dropdown-toggle' data-toggle='dropdown'><i class='fa fa-cogs'></i></button>
                    <ul class='dropdown-menu pull-right' role='menu'>
                    <li><a href='<?php echo site_url('op/po/payment_edit/'.$c->no)?>' >Edit</a></li>
                      <li><a href='<?php echo site_url('op/po/payment_delete/'.$c->no)?>' class="delete">Delete</a></li>
                    </ul>
                  </div>
                </td>
              </tr>
