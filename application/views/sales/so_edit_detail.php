        ...
        <div class="panel-body">
          <form class="form-horizontal" enctype="multipart/form-data" action="<?php echo site_url('sales/so/update_detail/'.$this->uri->segment(4));?>" method="post">
              ...
              <div class="form-group">
                ...
                <div class="col-md-3">
                 <select name="item" class="form-control" id="itemID">
                  ...
                  {
                    if($s->id == $so->row()->item){ ?>
                    <option value="<?php echo $s->id; ?>" selected><?php echo $s->code ?> - <?php echo $s->nama ?></option>
                    <?php } else { ?>
            ...
            <div class="form-group">
              ...
              <div class="col-md-3">
                <input id="brand" name="brand" placeholder="Brand" class="form-control" type="text" value="<?php echo $so->row()->brand; ?>" readonly></div>																						<label class="col-md-2 control-label" for="email">MoU</label>                                            <div class="col-md-3">                                                <input id="mou" name="mou" placeholder="MoU" class="form-control" type="text" value="<?php echo $so->row()->mou; ?>" readonly></div>
              </div>
              <div class="form-group">
                <label class="col-md-2 control-label" for="email">Qty</label>
                <div class="col-md-3">
                  <input id="email" name="qty" placeholder="Qty" class="form-control" type="text" value="<?php echo $so->row()->qty; ?>"></div>																						<label class="col-md-2 control-label" for="email">Unit Price</label>                                            <div class="col-md-3">                                                <input id="unit_price" name="price" placeholder="Unit Price" class="form-control" type="text" value="<?php echo $so->row()->price; ?>"></div>
                </div>
                <div class="form-group">
