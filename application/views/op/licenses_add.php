						...
						?>
							...
							<div class="panel panel-primary" id="hidepanel1">
								...
								<div class="panel-body">
									...
									<form class="form-horizontal" enctype="multipart/form-data" action="<?php echo site_url('op/licenses/save');?>" method="post">
										...
										<fieldset>
											...
											<div class="form-group">
												...
												<div class="col-md-3">
													...
													<input id="issuing" name="issuing" placeholder="Issuing Institution" class="form-control" type="text"></div>
											...
											<label class="col-md-2 control-label" for="license_no">License No</label>
												...
												<div class="col-md-3">
													...
													<input id="license_no" name="license_no" placeholder="License No" class="form-control" type="text"></div>

												<label class="col-md-2 control-label" for="email">Description</label>

												<div class="col-md-3">

													<input id="email" name="perihal" placeholder="Description" class="form-control" type="text"></div>
											...
											<div class="form-group">
												...
												<div class="col-md-3">
													...
													<input id="issurance" name="issurance" placeholder="dd MM YYYY" class="form-control datepicker" type="text"></div>
											...
											<div class="form-group">
												...
												<div class="col-md-3">
													...
													<input id="expiry" name="expiry" placeholder="dd MM YYYY" class="form-control datepicker" type="text"></div>
