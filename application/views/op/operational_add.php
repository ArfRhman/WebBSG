										...
										<fieldset>
											...
											<div class="form-group">
												...
												<div class="col-md-3">
													...
													<input id="no" name="no" placeholder="SOP No" class="form-control" type="text"></div>

												<label class="col-md-2 control-label" for="issued">Date of Issued</label>

												<div class="col-md-3">

													<input id="issued" name="issued" placeholder="dd MM YYYY" class="form-control datepicker" type="text"></div>
											...
											<label class="col-md-2 control-label" for="date">SOP Date</label>
												...
												<div class="col-md-3">
													...
													<input id="expired" name="expired" placeholder="Date of Expired" class="form-control datepicker" type="text"></div>
											...
											<div class="form-group">
												...
												<div class="col-md-3">
													<input id="remark" name="remark" placeholder="Remark" class="form-control" type="text"></div>
