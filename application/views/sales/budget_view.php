    ...
    <section class="content">
				<div class="row">
                    <div class="col-lg-12">
						...
						{
						?>
							<a href="<?php echo site_url('sales/budget/add')?>" class="btn btn-success">Add New Data</a>
						<?php
						}
						?>
												...
												<div class='btn-group'>
													<button type='button' class='btn btn-sm dropdown-toggle' data-toggle='dropdown'><i class='fa fa-cogs'></i></button>
														<ul class='dropdown-menu pull-right' role='menu'>															
															<li><a href='<?php echo site_url('sales/budget/edit/'.$c->no)?>' >Edit</a></li>
															<li><a href='<?php echo site_url('sales/budget/delete/'.$c->no);?>' class="delete" data-id = "<?php echo $c->no;?>">Delete</a></li>
														</ul>													
												</div>
											</td>
										</tr>
