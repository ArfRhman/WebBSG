  ...
  <section class="content">
    <div class="row">
        <div class="col-lg-12">
          ...
          {
            ?>							<a href="<?php echo site_url('op/bussiness/add')?>" class="btn btn-success">Add New Data</a>
            <?php
        }
        ?>
                   ...
                   foreach($business->result() as $c)
                   {
                       ...
                       <tr>
                        ...
                        <td><?php 
                           ...
                           {
                            echo anchor(base_url($c->document_template), "Download File");   
                        } ?></td>
                        <td>
                            <div class='btn-group'>
                                <button type='button' class='btn btn-sm dropdown-toggle' data-toggle='dropdown'><i class='fa fa-cogs'></i></button>
                                <ul class='dropdown-menu pull-right' role='menu'>
                                    <li><a href='<?php echo site_url('op/bussiness/edit/'.$c->no)?>' >Edit</a></li>
                                    <li><a href='<?php echo site_url('op/bussiness/delete/'.$c->no)?>' class="delete">Delete</a></li>
                                </ul>
                            </div>
                        </td>
                    </tr>
