...
<div class="panel-body">
    <table class="table table-striped table-responsive" id="table1">
        ...
        <tbody>
           <?php
           $no = 1;
           foreach($target->result() as $c)
           {
             ?>
             <tr>
                 <td><?php echo $no; ?></td>
                 <td><?php echo $this->mddata->getDataFromTblWhere('tbl_dm_personnel', 'id', $c->a_m)->row()->name; ?></td>
                 <td><?php echo $c->periode; ?></td>
                 <td><?php echo $this->mddata->getDataFromTblWhere('tbl_dm_operator', 'id', $c->operator)->row()->name; ?></td>
                 <td><?php echo $this->mddata->getDataFromTblWhere('tbl_dm_customer', 'id', $c->customer)->row()->name; ?></td>
                 <td><?php echo $c->amount; ?></td>
                 <td>
                    <div class='btn-group'>
                     <button type='button' class='btn btn-sm dropdown-toggle' data-toggle='dropdown'><i class='fa fa-cogs'></i></button>
                     <ul class='dropdown-menu pull-right' role='menu'>															
                       <li><a href='<?php echo site_url('sales/target/edit/'.$c->no)?>' >Edit</a></li>
                       <li><a href='<?php echo site_url('sales/target/delete/'.$c->no);?>' class="delete" data-id = "<?php echo $c->no;?>">Delete</a></li>
                   </ul>													
               </div>
           </td>
       </tr>
