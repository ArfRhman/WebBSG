									...
									<form class="form-horizontal" enctype="multipart/form-data" action="<?php echo site_url('op/outgoing/save');?>" method="post">
										...
										<fieldset>
											...
											<div class="form-group">
												...
												<label class="col-md-2 control-label" for="loa_no">LOA No</label>

												<div class="col-md-3">

													<input id="loa_no" name="loa_no" placeholder="LOA No" class="form-control" type="text"></div>
												
												<label class="col-md-2 control-label" for="authorizer_title">Authorizer Title</label>

												<div class="col-md-3">

													<input id="authorizer_title" name="authorizer_title" placeholder="Authorizer Title" class="form-control" type="text"></div>
											...
											<div class="form-group">
												...
												<div class="col-md-3">
													...
													<input id="load_date" name="load_date" placeholder="dd MMM YYYY" class="form-control datepicker" type="text"></div>
											...
											<div class="form-group">
												...
												<div class="col-md-3">
													...
													<input id="subject" name="subject" placeholder="Subject" class="form-control" type="text"></div>
													
												<label class="col-md-2 control-label" for="authorized_title">Authorized Title</label>

												<div class="col-md-3">

													<input id="authorized_title" name="authorized_title" placeholder="Authorized Title" class="form-control" type="text"></div>
											...
											<div class="form-group">
												...
												<div class="col-md-3">
													...
													<input id="authorized_id" name="authorized_id" placeholder="Authorized ID" class="form-control" type="text"></div>
											...
											<div class="form-group">
												...
												<div class="col-md-3">
													...
													<input id="archive" name="archive" placeholder="Archive code" class="form-control" type="text"></div>
