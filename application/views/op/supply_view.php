        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="panel-body">
                   ...
                   <div class="col-md-6 text-center">
                    <table class="table">
                        ...
                        <span style="font-size: 50px;" data-toggle="tooltip" data-placement="left" data-html="true"><?=round($sea['y']/$sea['total'])?> </span></td> </tr>
                    </table>
              ...
              <table class="table">
                        ...
                        <tr> <td class="cal-bg"> 
                        <span style="font-size: 50px;" data-toggle="tooltip" data-placement="left" data-html="true"><?=round($air['y']/$air['total'])?></span></td> </tr>
                    </table>
             </div>
