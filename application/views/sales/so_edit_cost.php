                ...
                <div class="panel-body">
                    <form class="form-horizontal" enctype="multipart/form-data" action="<?php echo site_url('sales/so/update_cost/'.$this->uri->segment(4));?>" method="post">
                        <fieldset>
                            ...
                            <div class="col-md-3">
                                <input id="Psalescom" name="sales_com" placeholder="%Salescom Proposed" class="form-control" type="text" onkeypress='return event.charCode >= 48 && event.charCode <= 57' value="<?php echo $so->row()->sales_com; ?>"></div>                                                                                       <label class="col-md-2 control-label" for="email">Salescom Proposed</label>                                         <div class="col-md-3">                                                <input id="salescom" name="sales" placeholder="Salescom Proposed" class="form-control" type="text" value="<?php echo $so->row()->sales; ?>" readonly></div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-2 control-label" for="email">%Bank Interest</label>
                                <div class="col-md-3">
                                    <input id="Pbankint" name="bank_interest" placeholder="%Bank Interest" class="form-control" type="text" onkeypress='return event.charCode >= 48 && event.charCode <= 57' value="<?php echo $so->row()->bank_interest; ?>"></div>                                                                                        <label class="col-md-2 control-label" for="email">Bank Interest</label>                                            <div class="col-md-3">                                                <input id="bankint" name="bank" placeholder="Bank Interest" class="form-control" type="text" readonly value="<?php echo $so->row()->bank; ?>"></div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-3">
                                                   ...
                                                   <div class="col-md-3">
                                                    <input id="Pextcom" name="extcom" placeholder="%Extcom Proposed" class="form-control" type="text" onkeypress='return event.charCode >= 48 && event.charCode <= 57' value="<?php echo $so->row()->extcom; ?>"></div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="col-md-2 control-label" for="email">Extcom Proposed</label>
                                                       <div class="col-md-3">
                                                        <input id="extcom" name="extcom_pro" placeholder="Extcom Proposed" class="form-control" type="text" readonly value="<?php echo $so->row()->extcom_pro; ?>"></div>
                                                            <label class="col-md-2 control-label" for="email">Income Tax</label>
                                                           <div class="col-md-3">
                                                            <input id="incomeTax" name="income" placeholder="Income Tax" class="form-control" type="text" onkeypress='return event.charCode >= 48 && event.charCode <= 57' value="<?php echo $so->row()->income; ?>"></div>
                                                            </div>
                                                            <div class="form-group">
                                                                <label class="col-md-2 control-label" for="email">Nett Extcom</label>
                                                                <div class="col-md-3">
                                                                <input id="nettExt" name="nett" placeholder="Nett Extcom" class="form-control" type="text" readonly value="<?php echo $so->row()->nett; ?>"></div>
