                                ...
                                <form class="form-horizontal" enctype="multipart/form-data" action="<?php echo site_url('sales/so/save_payment/'.$this->uri->segment(4));?>" method="post">
                                    <fieldset>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-3">
                                                <input id="name" name="reference" placeholder="Invoice Reference" class="form-control" type="text"></div>																						<label class="col-md-2 control-label" for="email">Payment Due Date</label>											<div class="col-md-3">                                                <input id="name" name="due_date" placeholder="Payment Due Date" class="form-control datepicker" type="text"></div>
                                        </div>
										<div class="form-group">
