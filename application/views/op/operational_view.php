      ...
      <section class="content">
        <div class="row">
            <div class="col-lg-12">
              ...
              {
                  ?>							<a href="<?php echo site_url('op/operational/add')?>" class="btn btn-success">Add New Data</a>
                  <?php
              }
              ?>
            ...
            <div class="panel-body">
                <table class="table table-striped table-responsive" id="table1">
                    ...
                    <tbody>
                     <?php
                     $no = 1;
                     foreach($operational->result() as $c)
                     {
                         ?>
                         <tr>
                            ...
                            <td><?php echo $c->date_if_expired; ?></td>
                            ...
                            <td>
                                <div class='btn-group'>
                                    ...
                                    <li><a href='<?php echo site_url('op/operational/edit/'.$c->no)?>' >Edit</a></li>
                                        <li><a href='<?php echo site_url('op/operational/delete/'.$c->no)?>' class="delete">Delete</a></li>
                                    </ul>
                                </div>
                            </td>
                        </tr>
